 ...
 * 
 * <p>
 * Java standard {@link BitSet} uses long as a word which means if you need to
 ...
 * 
 * <p>
 * This class is using int as word so it is possible to obtain array of integers
 * with no cost.
 * 
 */
public class IntBitSet {
     ...
     * after the specified starting index. If no such bit exists then return -1
     */
