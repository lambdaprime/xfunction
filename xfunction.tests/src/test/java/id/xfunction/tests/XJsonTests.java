...
public class XJsonTests {
    ...
    public void test_asJson_list() {
        assertEquals(
                resourceUtils.readResource(getClass(), "json-list"),
                XJson.asString("k1", 123, "k2", "ggg", "k3", List.of("sg", "dfg", "dsfg")));
    }
    ...
    public void test_asJson_null() {
        ...
        s.add("hh");
        assertEquals(
                resourceUtils.readResource(getClass(), "json-null"),
                XJson.asString("k1", null, "k2", "ggg", "k3", s));
    }
    ...
    public void test_asJson_collection_with_null() {
        assertEquals(
                resourceUtils.readResource(getClass(), "json-collection-null"),
                XJson.asString(
                        "obj1", new Obj(),
                        "obj2", new Obj(),
    ...
    public void test_empty() {
        assertEquals("{ \"k1\": \"\" }", XJson.asString("k1", ""));
    }

    @Test
    public void test_merge() {
        assertEquals(
                resourceUtils.readResource(getClass(), "json-merge"),
                XJson.merge(
                        XJson.asString(
                                "k1", "v1",
                                "k2", "v2"),
                        XJson.asString(
                                "k3", "v3",
                                "k4", "v4"),
                        XJson.asString("k5", "v5")));
    }

    @Test
    public void test_list_of_jsons() {
        assertEquals(
                resourceUtils.readResource(getClass(), "json-list-jsons"),
                XJson.asString(
                        "k3",
                        List.of(
                                XJson.asString(
        ...
        Object[] testData = {
            ...
            "k9",
                    new double[] {
                        ...
                        -0.0001,
                        -0.00003,
                        /* since it is double array next two ints will be doubles */ -0,
                        0
                    }
        };
